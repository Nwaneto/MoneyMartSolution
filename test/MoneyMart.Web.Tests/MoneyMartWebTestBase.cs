...
{
    public abstract class MoneyMartWebTestBase : AbpAspNetCoreIntegratedTestBase<Startup>
    {
        protected static readonly Lazy<string> ContentRootFolder;

        static MoneyMartWebTestBase()
        {
        ...
        protected override IWebHostBuilder CreateWebHostBuilder()
        {
            return base
                ...
                .UseSetting(WebHostDefaults.ApplicationKey, typeof(MoneyMartWebMvcModule).Assembly.FullName);
        }
        ...
        {
            using (var context = IocManager.Resolve<MoneyMartDbContext>())
            {
                action(context);
                context.SaveChanges();
            }
        ...
        protected async Task UsingDbContextAsync(Func<MoneyMartDbContext, Task> action)
        {
            using (var context = IocManager.Resolve<MoneyMartDbContext>())
            {
        ...
        protected async Task<T> UsingDbContextAsync<T>(Func<MoneyMartDbContext, Task<T>> func)
        {
            T result;
